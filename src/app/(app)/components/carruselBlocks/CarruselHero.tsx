...
const CarruselHero = ({data}) => {
    ...
    return (
        <section className='flex flex-col bg-secondary w-full h-full rounded-md gap-4 py-10 px-4' key={id}>
            ...
            <div className='flex flex-col-reverse lg:flex-row gap-4 justify-center items-start'>
                <p className='text-white text-left w-full lg:w-[70%] px-5 text-lg'>{Content}</p>
                <picture className='w-full lg:w-[30%] rounded-full border-2 border-dashed border-primary p-6'>
